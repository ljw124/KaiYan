package com.dcdz.kaiyanforkotlin.utils.log;
...
public class Log4jConfigure {
    ...
    private static final String DEFAULT_LOG_FILE_NAME = "db_kaiyan.txt";
    ...
    private static final String PACKAGE_NAME = "com.dcdz.kaiyanforkotlin";
    ...
    private static void configure(String fileName, String filePath) {
        ...
        try {
            ...
            fileName = filedir + File.separator + "ljw_kaiyan" + File.separator + "log" + File.separator + fileName;
